...
public class OMDBMovie {
    ...
    public OMDBMovie(String id, String title, String releaseDate, String duration, String realisateurs, String description, String langueOriginelle, String rating, String genres, String image) {
        this.id = id;
        this.title = title;
    ...
    public Film toFilm() {
        ...
        return new Film(getId(),title, title, description, releaseDate, userRating, langueOriginelle, genres, new ArrayList<String>(), new ArrayList<Oeuvre>(), Oeuvre.TypeStatut.EnCours, -1, "", image, false, duration, realisateurs, new ArrayList<>(), 0, 0);
    }
}
