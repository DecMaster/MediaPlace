...
public class VideoGamesBiblioFragment extends BiblioFragment {

    // PROPRIETES
    private ArrayList<Jeu> listeOeuvreActuelle;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        listeOeuvreActuelle = (ArrayList<Jeu>) Toolbox.instance.userBiblio.getBiblioJeux().getListeOeuvres();
        TrierListe(triActuel);
        OeuvreAdapter<Jeu> oeuvreAdapter = new OeuvreAdapter(this.getContext(), listeOeuvreActuelle);
        gridView.setAdapter(oeuvreAdapter);
        adapter = oeuvreAdapter;
        messageBiblioVide.setText(R.string.biblio_noGame);
        ...
        int color = getResources().getColor(R.color.colorVideoGamesRed);
        ...
        iconFiligran.setImageResource(R.drawable.videogames_icon);
        ...
        if(listeOeuvreActuelle.size() == 0){
            ...
            AdaptTextForSearch(messageRecherche, R.color.colorVideoGamesRed, R.drawable.ic_search_biblio_game);
        }

        // SETUP TEXTE BIBLIO VIDE
        messageBiblioVide.setText(R.string.biblio_noGame);
        AdaptTextForSearch(messageBiblioVide, R.color.colorVideoGamesRed, R.drawable.ic_search_biblio_game);
        ...
        // CHANGEMENT ONGLETS
        mTabLayout.setBackground(getResources().getDrawable(R.drawable.tablayout_game));
        mTabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                ArrayList<Jeu> listeNonFiltree = (ArrayList<Jeu>) Toolbox.instance.userBiblio.getBiblioJeux().getListeOeuvres();
                messageRecherche.setVisibility(View.VISIBLE);
                ...
                if(tab.getText().equals(tous) || listeNonFiltree.size() == 0){
                    ...
                    String messageVide = "Vous n'avez aucun jeu ";
                    ...
                    // FILTRAGE
                    if(statut != null){
                        ArrayList<Jeu> listeFiltree = (ArrayList<Jeu>) listeNonFiltree.stream().filter(statut).collect(Collectors.toList());
                        // APPLICATION
                        OeuvreAdapter<Jeu> oeuvreAdapterFiltre = new OeuvreAdapter(mContext, listeFiltree);
    ...
    public void TrierListe(OptionsTri option){
        ...
        // RELOAD
        triActuel = option;
        OeuvreAdapter<Jeu> oeuvreAdapter = new OeuvreAdapter(mContext, listeOeuvreActuelle);
        gridView.setAdapter(oeuvreAdapter);
    }
}
